...
list[nixpkgs]="$HOME/.config/nixpkgs/config.nix"
...
list[rofi]="$HOME/.config/rofi/config.rasi"
list[menus.conf]="$HOME/.local/bin/menus.conf"
list[polybar]="/home/john/.config/polybar/config.ini"
list[wezterm]="/home/john/.config/wezterm/wezterm.lua"
